...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 bg-white dark:bg-black">
      <main className="w-full max-w-2xl text-left">
        {/* Minimalist Logo/Header Area */}
        <header className="mb-12 flex items-center gap-3">
          <div className="h-8 w-8 bg-red-600 flex items-center justify-center text-white font-bold text-lg select-none">
            +
          </div>
